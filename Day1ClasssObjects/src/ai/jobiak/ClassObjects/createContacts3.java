...
public class createContacts3 {
	...
	public static void main(String[] args) {
		...
		// creating class class objects
				//we are trying to intiantiate the contact class
				Contact3 con1 = new Contact3(234, "harish", 7702005935L,"harish@gmail.com, ", "porus"); //the constuctor without parameters is called default constructor
				// Contact() is a objec
				// now memory is allocated on heap
				// now it have all the copy of dat7a members
